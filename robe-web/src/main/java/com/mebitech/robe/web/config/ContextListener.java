...
import com.mebitech.robe.common.converter.PropertySource;
import com.mebitech.robe.common.util.Strings;
import com.mebitech.robe.core.bundle.BundleBean;
import com.mebitech.robe.core.bundle.BundleBeanListener;
import com.mebitech.robe.core.bundle.BundleContext;
import com.mebitech.robe.core.bundle.BundleStarter;
...
public class ContextListener extends ServletRegistrationBean implements ServletContextListener, EventListener {
    ...
    private Map<String, Object> robe = new LinkedHashMap<>();
