...
import com.mebitech.robe.persistence.api.converter.Converter;
...
public class TransformerImpl<E> extends Transformer<E> {
    ...
    public List<E> list(Criteria<E> criteria) {
        ...
        List<E> destinationList = Converter.convert(criteria.getEntityClass(), getTransformClass(), finder, selectList,  query.getResultList());
    ...
    public Result<E> pairList(Criteria<E> criteria) {
        ...
        List<E> destinationList = Converter.convert(criteria.getEntityClass(), getTransformClass(), finder, selectList, listQuery.getResultList());
