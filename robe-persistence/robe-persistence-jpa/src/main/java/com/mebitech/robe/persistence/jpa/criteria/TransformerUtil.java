...
import com.mebitech.robe.common.lang.BooleanHolder;
import com.mebitech.robe.common.lang.Increment;
import com.mebitech.robe.common.lang.Pair;
    ...
    public static <E> void criteriaToQuery(
        ...
        if(criteria.getJoins() != null && criteria.getJoins().size() > 0) {
            for(Map.Entry<String, CriteriaJoin<E>> joinEntry: criteria.getJoins().entrySet()) {
                String joinToString = JpaQueryUtil.joinToString(joinEntry.getValue());
