package com.mebitech.robe.persistence.jpa.services;

import com.mebitech.robe.common.exception.ErrorCode;
import com.mebitech.robe.common.exception.RobeCommonException;
...
public class CrudService<T, ID extends Serializable> {
    ...
    public T update(T entity, ID id){
        if(!exists(id)) {
            throw new RobeCommonException(ErrorCode.HTTP_404, "Upgrading data not found ! ");
        }
        return crudRepository.save(entity);
    }
    ...
    public T delete(ID id) {
        T entity = findOne(id);
        if(entity == null) {
            throw new RobeCommonException(ErrorCode.HTTP_404, "Deleting data not found ! ");
        }
