...
import com.mebitech.robe.mail.queue.InMemoryMailQueue;
import com.mebitech.robe.mail.queue.MailQueue;
 ...
 * Every item in queue will be send only once. If any error occurs it is the developers responsibility to handle it. {@link com.mebitech.robe.mail.MailEvent}.
 */
public class MailManager {
    private static final Logger LOGGER = LoggerFactory.getLogger(MailManager.class);
    private static final MailQueue<MailPacket> queue = new InMemoryMailQueue();
    private static RobeMailSender sender;
