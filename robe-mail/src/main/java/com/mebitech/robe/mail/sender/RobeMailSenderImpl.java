...
import com.mebitech.robe.mail.MailConfiguration;
import com.mebitech.robe.mail.MailItem;
import com.mebitech.robe.mail.MailManager;
import com.mebitech.robe.mail.MailPacket;
 ...
 */
public class RobeMailSenderImpl implements RobeMailSender, Serializable {
    private static final Logger LOGGER = LoggerFactory.getLogger(RobeMailSender.class);
     ...
     */
    public RobeMailSenderImpl(MailConfiguration configuration) {
